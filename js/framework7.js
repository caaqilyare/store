...
(function () {
    ...
    Framework7.prototype.device = (function () {
        ...
        var iphoneXR = iphone && window.screen.width === 414 && window.screen.height === 896
        var iphoneXSMax = iphone && window.screen.width === 414 && window.screen.height === 896

        device.ios = device.android = device.windows = device.iphone = device.ipod = device.ipad = device.androidChrome = device.iphoneX = device.iphoneXR = device.iphoneXSMax = false;
        ...
        if (iphone && !ipod) {
            ...
            device.iphoneXR = iphoneXR;
            device.iphoneXSMax = iphoneXSMax;
        }
        if (ipad) {
        ...
        device.needsStatusBar = function () {
            if (device.webView && (windowWidth * windowHeight === screen.width * screen.height)) {
                if (device.iphoneX && (window.orientation === 90 || window.orientation === -90) || device.iphoneXR && (window.orientation === 90 || window.orientation === -90) || device.iphoneXSMax && (window.orientation === 90 || window.orientation === -90)) {
                    return false;
                }
                return true;
            }
